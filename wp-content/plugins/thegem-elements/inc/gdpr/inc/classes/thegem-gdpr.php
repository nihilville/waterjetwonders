...
class TheGemGdpr {
	...
	public static function get_consent_bar_position_list() {
		return array(
			static::CONSENT_BAR_POSITION_BOTTOM => __('Bottom'),
			static::CONSENT_BAR_POSITION_TOP => __('Top'),
		);
	}
	...
	public static function get_options() {
		...
		foreach (static::get_types_list() as $type) {
			$options[$type] = get_option(TheGemGdpr::OPTION_GROUP.'_'.$type) ? unserialize(get_option(TheGemGdpr::OPTION_GROUP.'_'.$type)) : null;
		}
		return $options;
	}
	...
	public function privacy_settings_link_shortcode($atts, $content = null) {
		$atts = shortcode_atts( array(
			'content' => $content ? esc_html($content) : __('Privacy Preferences'),
	...
	public static function get_consent_type_list() {
		return array(
			static::CONSENT_NAME_PRIVACY_POLICY=>__('Privacy Policy'),
			static::CONSENT_NAME_GOOGLE_FONTS => __('Google Fonts'),
			static::CONSENT_NAME_GOOGLE_MAPS => __('Google Maps'),
			static::CONSENT_NAME_TRACKING => __('Tracking'),
			static::CONSENT_NAME_YOUTUBE => __('YouTube'),
			static::CONSENT_NAME_VIMEO => __('Vimeo'),
			static::CONSENT_NAME_REQUIRED => __('Required'),
			//TheGemGdpr::CONSENT_NAME_INSTAGRAM => __('Instagram'),
			//TheGemGdpr::CONSENT_NAME_FACEBOOK => __('Facebook'),
			//TheGemGdpr::CONSENT_NAME_TWITTER => __('Twitter'),
			//TheGemGdpr::CONSENT_NAME_FLICKR => __('Flickr')
		);
	}
	...
	public function get_notice_text() {
		$notice = esc_html__('This content is blocked. Please review your [gem_privacy_settings_link]Privacy Settings[/gem_privacy_settings_link].');
