<form method="post" action="<?php echo esc_url(admin_url('options.php')); ?>" novalidate="novalidate">
	...
	<div class="thegem-gdpr-form-box">
		<div class="thegem-gdpr-field-box">
			...
			<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Privacy Policy Page'); ?></label>
			<div class="field">
		...
		<div class="thegem-gdpr-field-box">
			...
			<?php $default_value = __('Privacy Policy'); ?>
			<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Privacy Policy Link Text'); ?></label>
			<div class="field">
		...
		<div class="thegem-gdpr-field-box">
			...
			<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Cookies Policy Page'); ?></label>
			<div class="field">
				<select name="<?php echo $this->get_field_name($field); ?>" id="<?php echo $this->get_field_id($field); ?>">
					<option value="0"><?php _e('— Select —'); ?></option>
					<?php foreach (get_pages() as $page ) { ?>
		...
		<div class="thegem-gdpr-field-box">
			...
			<?php $default_value = __('Cookies Policy'); ?>
			<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Cookies Policy Link Text'); ?></label>
			<div class="field">
		...
		<div class="thegem-gdpr-field-box">
			...
			<?php $default_value = __('Privacy Preferences'); ?>
			<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Privacy Preferences Modal Title'); ?></label>
			<div class="field">
				<input name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>" >
			</div>
		</div>
		<div class="thegem-gdpr-field-box">
			...
			<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Privacy Excerpt Text For Privacy Modal'); ?></label>
			<div class="field">
		...
		<div class="thegem-gdpr-field-box">
			...
			<?php $default_value = __('This content is blocked. Please review your [gem_privacy_settings_link]Privacy Preferences[/gem_privacy_settings_link].')?>
			<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Consent Notice Text In Content'); ?></label>
			<div class="field">
				<textarea name="<?php echo $this->get_field_name($field); ?>" rows="6"  id="<?php echo $this->get_field_id($field); ?>"><?php echo esc_attr($this->get_field_value($field, $default_value)); ?></textarea>
			</div>
			<p class="thegem-gdpr-field-notice"><?php _e('Important: No HTML code is allowed. Use the shortcode [gem_privacy_settings_link]Your Text[/gem_privacy_settings_link] to print a link that opens the preferences box.') ?></p>
		</div>
		<div class="thegem-gdpr-field-box">
			<?php $field = 'save_preferences_button_text'; ?>
			<?php $default_value = __('Save Preferences'); ?>
			<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('"Save Preferences" Button Text'); ?></label>
			<div class="field">
				<input name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>" >
			</div>
		</div>
	...
	<div class="thegem-gdpr-consent-type-added thegem-gdpr-field-box">
		...
		<button type="button" class="button thegem-gdpr-consent-add"><?php _e('Add')?></button>
	</div>
			...
			<?php foreach ($consents as $consent_type=>$consent_item) { ?>
				<div class="thegem-gdpr-consent-type-item" id="<?php echo $this->get_field_id(array('consents', $consent_type)); ?>">
					<div class="thegem-gdpr-consent-type-head">
						...
						<button class="thegem-gdpr-consent-type-delete button" type="button"><?php _e('Remove'); ?></button>
					</div>
						...
						<div class="thegem-gdpr-form-box">
							<?php if (in_array($consent_type, $this->get_consents_with_field_required())) { ?>
								<div class="thegem-gdpr-field-box">
									...
									<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Required'); ?></label>
							...
							<?php if (in_array($consent_type, $this->get_consents_with_field_title())) { ?>
								<div class="thegem-gdpr-field-box thegem-gdpr-consent-title-field">
									...
									<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Consent title'); ?></label>
									<div class="field">
							...
							<?php if (in_array($consent_type, $this->get_consents_with_field_state())) { ?>
								<div class="thegem-gdpr-field-box thegem-gdpr-consent-state-field <?php echo ($this->get_field_value($field) ? 'hide' : ''); ?>">
									...
									<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Active by default'); ?></label>
									<div class="field">
										<input name="<?php echo $this->get_field_name($field); ?>" <?php checked($this->get_field_value($field)); ?> id="<?php echo $this->get_field_id($field); ?>" type="checkbox">
									</div>
								</div>
							...
							<div class="thegem-gdpr-field-box">
								...
								<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Consent description'); ?></label>
								<div class="field">
							...
							<div class="thegem-gdpr-allowed-tag"><?php echo __('You can use:').' '.TheGemGdpr::get_allowed_html_tags_output(); ?></div>

							<?php if (in_array($consent_type, $this->get_consents_with_field_poster())) { ?>
								<div class="thegem-gdpr-field-box">
									<?php $field = array('consents', $consent_type, 'poster'); ?>
									<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Consent Poster'); ?></label>
									<div class="field">
							...
							<?php if ($consent_type == TheGemGdpr::CONSENT_NAME_GOOGLE_FONTS && !TheGemGdprAdmin::is_selected_fallback_fonts()) { ?>
								<p><?php _e('No fallback fonts are selected.'); ?> <a href="<?php echo esc_url(admin_url('admin.php?page=fonts-manager')); ?>" target="_blank"><?php _e('Setup fallback fonts'); ?></a></p>
							<?php } ?>
	...
	<br>
	<br>
	<h2><?php _e('Privacy Preferences Overlay Styling'); ?></h2>
	<div class="thegem-gdpr-form-box">
		<div class="thegem-gdpr-field-box">
			<?php $field = 'use_overlay_custom_styles'; ?>
			<label for=""><?php _e('Use custom styles'); ?></label>
			<div class="field">
	...
	<div class="thegem-gdpr-overlay-custom-styles-box <?php echo ($this->get_field_value($field) ? 'active' : ''); ?>">
		<div class="thegem-gdpr-form-box">
			<div class="thegem-gdpr-field-box">
				...
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Website Background Fill Color'); ?></label>
				<div class="field">
			...
			<div class="thegem-gdpr-field-box">
				...
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Website Background Fill Opacity (0-100%)'); ?></label>
			...
			<div class="thegem-gdpr-field-box">
				...
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Overlay Background Color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			<div class="thegem-gdpr-field-box">
				...
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Bottom Bar Background Color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			<div class="thegem-gdpr-field-box">
				<label><?php _e('Title font'); ?></label>
				<fieldset class="thegem-gdpr-fieldset">
					<div>
						...
						<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Font Family'); ?></label>
						<div class="field">
					...
					<div>
						...
						<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Font Style'); ?></label>
						<div class="field">
					...
					<div>
						...
						<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Font Sets'); ?></label>
						<div class="field">
							...
							<button type="button" class="btn-get-all-sets-font button"><?php _e('Get all from font') ?></button>
						</div>
					</div>
					<div>
						<?php $field = array('overlay_styles', 'title_font', 'font_size'); ?>
						<?php $default_value = 24; ?>
						<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Font Size'); ?></label>
						<div class="field fixed-number">
					...
					<div>
						...
						<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Line Height'); ?></label>
						<div class="field fixed-number">
			...
			<div class="thegem-gdpr-field-box">
				...
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Title color '); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			<div class="thegem-gdpr-field-box">
				...
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Title icon color '); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			<div class="thegem-gdpr-field-box">
				<label><?php _e('Text font'); ?></label>
				<fieldset class="thegem-gdpr-fieldset">
					<div>
			...
			<div class="thegem-gdpr-field-box">
				...
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Text color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			<div class="thegem-gdpr-field-box">
				...
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Separator color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			<div class="thegem-gdpr-field-box">
				...
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('"Disabled" background color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			<div class="thegem-gdpr-field-box">
				...
				<?php $default_value = '#00bcd4'; ?>
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('"Enabled" background color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			<div class="thegem-gdpr-field-box">
				...
				<?php $default_value = '#00bcd4'; ?>
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Button text color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			...
			<div class="thegem-gdpr-field-box">
				...
				<?php $default_value = '#f0f3f2'; ?>
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Button text hover color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			...
			<div class="thegem-gdpr-field-box">
				...
				<?php $default_value = '#f0f3f2'; ?>
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Button background color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			...
			<div class="thegem-gdpr-field-box">
				...
				<?php $default_value = '#00bcd4'; ?>
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Button background hover color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			...
			<div class="thegem-gdpr-field-box">
				...
				<?php $default_value = '#00bcd4'; ?>
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Button border color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			...
			<div class="thegem-gdpr-field-box">
				...
				<?php $default_value = '#00bcd4'; ?>
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Button border hover color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			...
			<div class="thegem-gdpr-field-box">
				...
				<?php $default_value = '#00bcd4'; ?>
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Link color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
			...
			<div class="thegem-gdpr-field-box">
				...
				<?php $default_value = '#00bcd4'; ?>
				<label for="<?php echo $this->get_field_id($field); ?>"><?php _e('Link hover color'); ?></label>
				<div class="field">
					<input class="thegem-gdpr-color-picker" name="<?php echo $this->get_field_name($field); ?>" value="<?php echo esc_attr($this->get_field_value($field, $default_value)); ?>" type="text" id="<?php echo $this->get_field_id($field); ?>">
				</div>
			</div>
		...
		<div class="thegem-gdpr-consent-type-body">
			...
			<div class="thegem-gdpr-form-box">
				<div class="thegem-gdpr-field-box thegem-gdpr-consent-required-field">
					<?php $field = 'required'; ?>
					<label for="<?php echo $this->get_field_id($fieldGroup); ?>-{{type}}-<?php echo $field; ?>"><?php _e('Required'); ?></label>
					<div class="field thegem-gdpr-consent-required-field">
				...
				<div class="thegem-gdpr-field-box thegem-gdpr-consent-state-field">
					<?php $field = 'state'; ?>
					<label for="<?php echo $this->get_field_id($fieldGroup) ?>-{{type}}-<?php echo $field; ?>"><?php _e('Active by default'); ?></label>
					<div class="field">
				...
				<div class="thegem-gdpr-field-box thegem-gdpr-consent-title-field">
					<?php $field = 'title'; ?>
					<label for="<?php echo $this->get_field_id($fieldGroup); ?>-{{type}}-<?php echo $field; ?>"><?php _e('Consent title'); ?></label>
					<div class="field">
				...
				<div class="thegem-gdpr-field-box">
					...
					<label for="<?php echo $this->get_field_id($fieldGroup); ?>-{{type}}-<?php echo $field; ?>"><?php _e('Consent description'); ?></label>
					<div class="field">
				...
				<div class="thegem-gdpr-field-box thegem-gdpr-consent-poster-field">
					<?php $field = 'poster'; ?>
					<label for="<?php echo $this->get_field_id($fieldGroup); ?>-{{type}}-<?php echo $field; ?>"><?php _e('Consent Poster'); ?></label>
					<div class="field">
				...
				<?php if (!TheGemGdprAdmin::is_selected_fallback_fonts()) { ?>
					<p class="thegem-gdpr-consent-google-fonts-notice"><?php _e('No fallback fonts are selected.'); ?> <a href="<?php echo esc_url(admin_url('admin.php?page=fonts-manager')); ?>" target="_blank"><?php _e('Setup fallback fonts'); ?></a></p>
				<?php } ?>
			</div>
		</div>
	</div>
